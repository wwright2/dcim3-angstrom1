...
module RbConfig
  ...
  CONFIG["configure_args"] = " '--build=x86_64-linux' '--host=arm-angstrom-linux-gnueabi' '--target=arm-angstrom-linux-gnueabi' '--prefix=/usr' '--exec_prefix=/usr' '--bindir=/usr/bin' '--sbindir=/usr/sbin' '--libexecdir=/usr/lib/ruby' '--datadir=/usr/share' '--sysconfdir=/etc' '--sharedstatedir=/com' '--localstatedir=/var' '--libdir=/usr/lib' '--includedir=/usr/include' '--oldincludedir=/usr/include' '--infodir=/usr/share/info' '--mandir=/usr/share/man' '--disable-silent-rules' '--disable-dependency-tracking' '--with-libtool-sysroot=/' '--enable-wide-getaddrinfo' '--disable-versioned-paths' '--disable-rpath' '--enable-shared' '--enable-load-relative' '--with-valgrind=no' 'build_alias=x86_64-linux' 'host_alias=arm-angstrom-linux-gnueabi' 'target_alias=arm-angstrom-linux-gnueabi' 'CC=arm-angstrom-linux-gnueabi-gcc  -march=armv7-a -mthumb -mthumb-interwork -mfloat-abi=hard -mfpu=neon --sysroot=/' 'CFLAGS= -O2 -pipe -g -feliminate-unused-debug-types' 'LDFLAGS=-Wl,-O1 -Wl,--hash-style=gnu -Wl,--as-needed' 'CPPFLAGS=' 'CXX=arm-angstrom-linux-gnueabi-g++  -march=armv7-a -mthumb -mthumb-interwork -mfloat-abi=hard -mfpu=neon --sysroot=/' 'CXXFLAGS= -O2 -pipe -g -feliminate-unused-debug-types -fvisibility-inlines-hidden' 'CPP=arm-angstrom-linux-gnueabi-gcc -E --sysroot=/  -march=armv7-a -mthumb -mthumb-interwork -mfloat-abi=hard -mfpu=neon'"
  ...
  CONFIG["CPP"] = "arm-angstrom-linux-gnueabi-gcc -E --sysroot=/  -march=armv7-a -mthumb -mthumb-interwork -mfloat-abi=hard -mfpu=neon"
  CONFIG["CXXFLAGS"] = " -O2 -pipe -g -feliminate-unused-debug-types -fvisibility-inlines-hidden"
  CONFIG["CXX"] = "arm-angstrom-linux-gnueabi-g++  -march=armv7-a -mthumb -mthumb-interwork -mfloat-abi=hard -mfpu=neon --sysroot=/"
  CONFIG["OBJEXT"] = "o"
  ...
  CONFIG["CC"] = "arm-angstrom-linux-gnueabi-gcc  -march=armv7-a -mthumb -mthumb-interwork -mfloat-abi=hard -mfpu=neon --sysroot=/"
