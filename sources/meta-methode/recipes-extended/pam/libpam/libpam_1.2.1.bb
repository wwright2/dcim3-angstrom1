...
LIC_FILES_CHKSUM = "file://COPYING;md5=7eb5c1bf854e8881005d673599ee74d3"
SRC_URI = "http://cti-dcim01/dcim3-pkgs/Linux-PAM-${PV}.tar.gz;name=cti"
#SRC_URI += "http://www.linux-pam.org/library/Linux-PAM-${PV}.tar.gz;name=pamorg"
#SRC_URI += "https://git.fedorahosted.org/cgit/linux-pam.git/snapshot/Linux-PAM-1_2_1.tar.gz;name=fedora"
...
DEPENDS = "db bison flex flex-native cracklib"
...
CFLAGS_append = " -fPIC -I${STAGING_INCDIR}"
...
addtask pam_copy_includes after do_configure
...
do_install() {
	...
	install -d ${D}/usr/include/security/     
	install -m 0644 ${S}/libpam/include/security/* ${D}/usr/include/security
	install -m 0644 ${S}/libpam_misc/include/security/* ${D}/usr/include/security
